...
import { Mail, Package, Settings } from 'lucide-vue-next';
...
const processedOrdersPath = '/admin/products/processed-orders';
...
const breadcrumbs = [
    ...
    { title: 'Processed Orders', href: processedOrdersPath },
];
...
const changePage = (page: number) => {
    router.get(processedOrdersPath, { page, per_page: props.orders.per_page }, {
        preserveScroll: true,
        preserveState: true,
        replace: true,
    });
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Processed Orders</h1>
                    <p class="text-muted-foreground">
                        Orders currently in processing and preparing for shipment.
                    </p>
                </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <Card v-for="order in formattedOrders" :key="order.id">
                    ...
                    <CardContent class="space-y-2 text-sm">
                        ...
                        <p><span class="font-medium">Status:</span> {{ order.status || 'Processing' }}</p>
                        <p>
                        ...
                        <p class="text-xs text-muted-foreground">Updated: {{ formatDate(order.created_at || '') || '-' }}</p>
                        <Button
            ...
            <Dialog v-model:open="isItemsDialogOpen">
                <DialogContent class="max-h-[80vh] overflow-y-auto sm:max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Products included in this processed order.
                        </DialogDescription>
                    </DialogHeader>
