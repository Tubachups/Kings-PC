...
import {
    advancePendingOrder,
    processedOrders as processedOrdersAction,
...
const breadcrumbs = [
    ...
    { title: 'Processed Orders', href: processedOrdersAction().url },
];
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <OrdersHeader title="Processed Orders" description="Orders currently in processing and preparing for shipment." />
